									...
									<div class="row">
										...
										<div class="col-md-6 text-right">
											...
											<?php foreach ($seleksi_aktif_ar_detail as $j): ?>
												<?php if ($j->id_stage == $i->id_stage && $j->label == 'Tahap 4' && $j->end_stage < $today && $this->session->userdata('akses') == '1' && $j->id_stage == $i->id_stage): ?>
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-6 text-right">
												...
												<?php foreach ($seleksi_aktif_ar_detail as $j): ?>
													<?php if ($j->start_stage < $today && $j->end_stage > $today && $j->label == 'Tahap 1' && $j->id_stage == $i->id_stage): ?>
										...
										<div class="row">
											...
											<div class="col-md-6 text-right">
												...
												<?php foreach ($seleksi_aktif_ar_detail as $j): ?>
													<?php if ($j->start_stage < $today && $j->end_stage > $today && $j->label == 'Tahap 2' && $j->id_stage == $i->id_stage): ?>
														<a href="<?php echo site_url('sesi/next/').$j->id; ?>" class="btn btn-outline-info btn-sm"><i class="fas fa-arrow-right"></i> Next Step</a>
													<?php endif ?>
												<?php endforeach ?>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-6 text-right">
												...
												<?php foreach ($seleksi_aktif_ar_detail as $j): ?>
													<?php if ($j->start_stage < $today && $j->end_stage > $today && $j->label == 'Tahap 3' && $j->id_stage == $i->id_stage): ?>
														<a href="<?php echo site_url('sesi/next/').$j->id; ?>" class="btn btn-outline-info btn-sm"><i class="fas fa-arrow-right"></i> Next Step</a>
													<?php endif ?>
												<?php endforeach ?>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-6 text-right">
												...
												<?php foreach ($seleksi_aktif_ar_detail as $j): ?>
													<?php if ($j->start_stage < $today && $j->end_stage > $today && $j->label == 'Tahap 4' && $j->id_stage == $i->id_stage): ?>
														<a href="<?php echo site_url('sesi/next/').$j->id; ?>" class="btn btn-outline-info btn-sm"><i class="fas fa-arrow-right"></i> Next Step</a>
													<?php endif ?>
												<?php endforeach ?>
											</div>
