<?php foreach ($usr as $i): ?>
	...
	<div class="container-fluid">
		<div class="card">
			...
			<div class="card-body">
				<h2 class="text-center">Ujian Tatap Muka</h2>

				<?php echo form_open('start/submit_f2f'); ?>
						<?php $count = 1; ?>

						<?php foreach ($soal_f2f as $j): ?>
							<?php if ($i->label_f2f == $j->label): ?>
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-md-1">
					...
					<?php foreach ($tahapan as $i): ?>
						<?php if ($i->label == 'Tahap 4' && $i->start_stage >= $today): ?>
							<div class="form-group text-right">
